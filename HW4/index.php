      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">   <!-- -->
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $works[0]['startDate']; ?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $works[0]['endDate']; ?></span></h6>
            <p><?php echo $works[0]['description']; ?></p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $works[1]['name']; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $works[1]['startDate']; ?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $works[1]['endDate']; ?></span></h6>
            <p><?php echo $works[1]['description']; ?></p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $works[2]['name']; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $works[2]['startDate']; ?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $works[2]['endDate']; ?></span></h6>
            <p><?php echo $works[2]['description']; ?></p><br>
          </div>
        </div>
